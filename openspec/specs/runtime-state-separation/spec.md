...
Define how runtime state is separated across protagonist state, world snapshot, and task state, including protagonist resources and Runtimekeeper's on-demand maintenance behavior.
